...
describe('mathExact', () => {
  ...
  // Test #38
  test('Test #38', () => {
    expect(mathExact('Divide', .002, 1.123)).toEqual(.0017809439002671415);
  });

  // Test #39
  test('Test #39', () => {
    expect(mathExact('Divide', .02, 1.123)).toEqual(.017809439002671415);
  });

  // Test #40
  test('Test #40', () => {
    expect(mathExact('Divide', .2, 1.123)).toEqual(.17809439002671415);
  });
});
